...
def replay(config_dir, algo: dict, target, oos_X: np.ndarray) -> ReplayResult:
    ...
    for b in range(budget):
        ...
        # mirror CBOSS._post_observe: refit every freq_update on accumulated data
        if (b + 1) % freq_update == 0:
