...
from app.constants.algo_config import (
...
from app.constants.tooltips import (
    SEEDS, CUDA_DEVICE, TMUX_SESSION, RUN_NAME,
...
# ---------------------------------------------------------------------------
# Algorithm configs — the heart of Phase 2
# ---------------------------------------------------------------------------
...
def _render_algo_configs(cfg: SidebarConfig) -> None:
