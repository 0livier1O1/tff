...
if cfg.app_mode == "Load Past Artifact":
    data_ready, df_mabss, df_boss, summaries, decomp_dict, df_summary, out_dir = render_load_mode(ROOT)

if data_ready:
    render_results(df_mabss, df_boss, summaries, decomp_dict, df_summary, out_dir, ROOT)
